<?php require_once 'inc/header.php';?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Sayfa Listesi</h1>
        </div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <?php foreach($query as $row){ ?>
                    ...
                    <td><img src="<?php echo $site."/uploads/".$row['kapak'];?>" width="100" height="100" /></td>
                    <td><?php echo $row['baslik'];?></td>
                    <td><?php echo dt($row['tarih']);?></td>

                    <td><?php echo $row['durum'] == 1 ? '<span class="badge badge-success ">Aktif</span>' : '<span class="badge badge-danger">Pasif</span>';?></td>
                 
                    <td>
                      <a title="Sayfa düzenle" href="<?php b2b('pageedit',$row['id']);?>"><i class="fa fa-edit"></i></a> | 
                      <a onclick="return confirm('Onaylıyor musunuz?');" title="sayfa sil" href="<?php b2b('pagedelete',$row['id']);?>"><i class="fa fa-close"></i></a>
                    </td>
